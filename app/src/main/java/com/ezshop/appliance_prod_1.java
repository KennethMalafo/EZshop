...
public class appliance_prod_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_prod1);
        ...
        share.setOnClickListener(v ->{
            ShareApp(appliance_prod_1.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(appliance_prod_1.this, ReviewsActivity.class));
