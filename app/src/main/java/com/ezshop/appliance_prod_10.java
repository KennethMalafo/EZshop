...
public class appliance_prod_10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_prod10);
        ...
        share.setOnClickListener(v ->{
            ShareApp(appliance_prod_10.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(appliance_prod_10.this, ReviewsActivity.class));
