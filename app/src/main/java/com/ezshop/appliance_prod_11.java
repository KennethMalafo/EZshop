...
public class appliance_prod_11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_prod11);
        ...
        share.setOnClickListener(v ->{
            ShareApp(appliance_prod_11.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(appliance_prod_11.this, ReviewsActivity.class));
