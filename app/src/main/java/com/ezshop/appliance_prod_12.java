...
public class appliance_prod_12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_prod12);
        ...
        share.setOnClickListener(v ->{
            ShareApp(appliance_prod_12.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(appliance_prod_12.this, ReviewsActivity.class));
