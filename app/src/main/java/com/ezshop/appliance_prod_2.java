...
public class appliance_prod_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_prod2);
        ...
        share.setOnClickListener(v ->{
            ShareApp(appliance_prod_2.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(appliance_prod_2.this, ReviewsActivity.class));
