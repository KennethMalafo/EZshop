...
public class appliance_prod_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_prod4);
        ...
        share.setOnClickListener(v ->{
            ShareApp(appliance_prod_4.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(appliance_prod_4.this, ReviewsActivity.class));
