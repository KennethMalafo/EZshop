...
public class appliance_prod_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_prod5);
        ...
        share.setOnClickListener(v ->{
            ShareApp(appliance_prod_5.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(appliance_prod_5.this, ReviewsActivity.class));
