...
public class appliance_prod_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_prod6);
        ...
        share.setOnClickListener(v ->{
            ShareApp(appliance_prod_6.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(appliance_prod_6.this, ReviewsActivity.class));
