...
public class appliance_prod_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_prod7);
        ...
        share.setOnClickListener(v ->{
            ShareApp(appliance_prod_7.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(appliance_prod_7.this, ReviewsActivity.class));
