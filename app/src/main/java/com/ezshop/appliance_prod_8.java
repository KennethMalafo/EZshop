...
public class appliance_prod_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_prod8);
        ...
        share.setOnClickListener(v ->{
            ShareApp(appliance_prod_8.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(appliance_prod_8.this, ReviewsActivity.class));
