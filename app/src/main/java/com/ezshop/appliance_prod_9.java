...
public class appliance_prod_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance_prod9);
        ...
        share.setOnClickListener(v ->{
            ShareApp(appliance_prod_9.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(appliance_prod_9.this, ReviewsActivity.class));
