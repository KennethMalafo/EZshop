...
public class baby_prod_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod1);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_1.this, ReviewsActivity.class));
