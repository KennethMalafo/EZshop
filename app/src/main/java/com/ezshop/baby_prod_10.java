...
public class baby_prod_10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod10);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_10.this, ReviewsActivity.class));
