...
public class baby_prod_11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod11);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_11.this, ReviewsActivity.class));
