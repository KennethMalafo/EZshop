...
public class baby_prod_12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod12);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_12.this, ReviewsActivity.class));
