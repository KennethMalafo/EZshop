...
public class baby_prod_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod2);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_2.this, ReviewsActivity.class));
