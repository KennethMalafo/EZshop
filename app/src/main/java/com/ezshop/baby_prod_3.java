...
public class baby_prod_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod3);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_3.this, ReviewsActivity.class));
