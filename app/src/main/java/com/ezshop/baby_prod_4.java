...
public class baby_prod_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod4);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_4.this, ReviewsActivity.class));
