...
public class baby_prod_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod5);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_5.this, ReviewsActivity.class));
