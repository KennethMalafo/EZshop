...
public class baby_prod_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod6);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_6.this, ReviewsActivity.class));
