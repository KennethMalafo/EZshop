...
public class baby_prod_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod7);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_7.this, ReviewsActivity.class));
