...
public class baby_prod_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod8);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_8.this, ReviewsActivity.class));
