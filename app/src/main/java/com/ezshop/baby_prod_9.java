...
public class baby_prod_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_prod9);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(baby_prod_9.this, ReviewsActivity.class));
