...
public class children_prod_1 extends AppCompatActivity {
    ...
    public void Reviews(View view) {
        startActivity(new Intent(children_prod_1.this, ReviewsActivity.class));
