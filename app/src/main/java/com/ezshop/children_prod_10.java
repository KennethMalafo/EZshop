...
public class children_prod_10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_children_prod10);
        ...
        share.setOnClickListener(v ->{
            ShareApp(children_prod_10.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(children_prod_10.this, ReviewsActivity.class));
