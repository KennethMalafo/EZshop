...
public class children_prod_11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_children_prod11);
        ...
        share.setOnClickListener(v ->{
            ShareApp(children_prod_11.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(children_prod_11.this, ReviewsActivity.class));
