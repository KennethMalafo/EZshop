...
public class children_prod_12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_children_prod12);
        ...
        share.setOnClickListener(v ->{
            ShareApp(children_prod_12.this);
        });
    ...
    public void Reviews(View view) {
        startActivity(new Intent(children_prod_12.this, ReviewsActivity.class));
