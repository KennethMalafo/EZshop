...
public class children_prod_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_children_prod2);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(children_prod_2.this, ReviewsActivity.class));
