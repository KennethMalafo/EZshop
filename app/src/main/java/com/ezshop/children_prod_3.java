...
public class children_prod_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_children_prod3);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(children_prod_3.this, ReviewsActivity.class));
