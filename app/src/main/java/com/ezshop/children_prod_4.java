...
public class children_prod_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_children_prod4);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(children_prod_4.this, ReviewsActivity.class));
