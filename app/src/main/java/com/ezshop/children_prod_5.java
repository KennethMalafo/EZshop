...
public class children_prod_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_children_prod5);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(children_prod_5.this, ReviewsActivity.class));
