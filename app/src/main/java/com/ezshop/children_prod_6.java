...
public class children_prod_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_children_prod1);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(children_prod_6.this, ReviewsActivity.class));
