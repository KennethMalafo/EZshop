...
public class children_prod_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_children_prod8);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(children_prod_8.this, ReviewsActivity.class));
