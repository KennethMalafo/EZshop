...
public class children_prod_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_children_prod9);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(children_prod_9.this, ReviewsActivity.class));
