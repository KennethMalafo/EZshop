...
public class prod_10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prod10);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(prod_10.this, ReviewsActivity.class));
