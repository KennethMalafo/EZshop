...
public class prod_11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prod11);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(prod_11.this, ReviewsActivity.class));
