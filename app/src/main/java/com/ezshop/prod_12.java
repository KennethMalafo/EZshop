...
public class prod_12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prod12);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(prod_12.this, ReviewsActivity.class));
