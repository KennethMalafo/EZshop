...
public class prod_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prod7);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(prod_7.this, ReviewsActivity.class));
