...
public class prod_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prod8);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(prod_8.this, ReviewsActivity.class));
