...
public class prod_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prod9);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(prod_9.this, ReviewsActivity.class));
