...
public class women_prod_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_prod1);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(women_prod_1.this, ReviewsActivity.class));
