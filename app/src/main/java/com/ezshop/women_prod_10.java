...
public class women_prod_10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_prod10);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(women_prod_10.this, ReviewsActivity.class));
