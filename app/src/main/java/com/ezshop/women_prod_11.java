...
public class women_prod_11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_prod11);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(women_prod_11.this, ReviewsActivity.class));
