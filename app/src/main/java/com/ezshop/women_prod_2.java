...
public class women_prod_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_prod2);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(women_prod_2.this, ReviewsActivity.class));
