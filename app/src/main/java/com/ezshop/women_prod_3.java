...
public class women_prod_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_prod3);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(women_prod_3.this, ReviewsActivity.class));
