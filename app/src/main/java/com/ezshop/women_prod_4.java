...
public class women_prod_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_prod4);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(women_prod_4.this, ReviewsActivity.class));
