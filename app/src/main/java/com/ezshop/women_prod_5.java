...
public class women_prod_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_prod5);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(women_prod_5.this, ReviewsActivity.class));
