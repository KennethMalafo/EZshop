...
public class women_prod_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_prod6);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(women_prod_6.this, ReviewsActivity.class));
