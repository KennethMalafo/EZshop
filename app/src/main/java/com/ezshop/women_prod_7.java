...
public class women_prod_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_prod7);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(women_prod_7.this, ReviewsActivity.class));
