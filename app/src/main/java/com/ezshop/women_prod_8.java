...
public class women_prod_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_prod8);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(women_prod_8.this, ReviewsActivity.class));
