...
public class women_prod_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_women_prod9);
    ...
    public void Reviews(View view) {
        startActivity(new Intent(women_prod_9.this, ReviewsActivity.class));
